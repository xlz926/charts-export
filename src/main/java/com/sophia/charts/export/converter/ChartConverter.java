...
import com.sophia.charts.export.pool.BlockingQueuePool;
import com.sophia.charts.export.pool.PoolException;
import com.sophia.charts.export.server.Server;
import com.sophia.charts.export.util.MimeType;
...
public class ChartConverter {
	...
	public ByteArrayOutputStream convert(String input, MimeType mime,
			String constructor, String callback, Float width, Float scale) throws ChartConverterException, IOException, PoolException, NoSuchElementException, TimeoutException {
	...
	public ByteArrayOutputStream convert(String input, String globalOptions, String dataOptions, String customCode, MimeType mime,
			...
			if (output.substring(0,5).equalsIgnoreCase("error")) {
				...
				throw new ChartConverterException("recveived error from phantomjs:" + output);
			}
	...
	public String requestServer(String params) throws ChartConverterException, TimeoutException, NoSuchElementException, PoolException {
		Server server = null;
